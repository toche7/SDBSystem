...
<div class="container">
  ...
  <div class="row">
	<div class="col-sm-3">
      ...
      <div class="panel panel-default">
       ...
       <h4><i class="glyphicon glyphicon-lock"></i> เข้าระบบ</h4>
     </div>
      ...
      <div class="panel panel-default">
    <div class="panel-heading">
      <h4><i class="glyphicon glyphicon-hdd"></i> งานวิจัย/บริการวิชาการ</h4>
    </div>
    ...
    <div class="panel panel-default">
    <div class="panel-heading">
    <h4><i class="glyphicon glyphicon-wrench"></i> ข้อมูล</h4>
    </div>
     <div class="pannel-body">
        <ul class="nav nav-stacked">
             <li><a href="http://www.bootply.com/85861" target="ext"><i class="glyphicon glyphicon-time"></i> ประวัตินักวิจัย</a></li>
            <li><a href="insert"><i class="glyphicon glyphicon-plus"></i> จัดการข้อมูล</a></li>
      </ul>
    </div>
  </div>
  	</div><!-- /span-3 -->
      ...
      <!-- column 2 -->
	   ...
	   <div class="row">
			...
			<!--  <div class="well">Inbox Messages <span class="badge pull-right">3</span></div>
              ...
              <div class="panel panel-default">
                  <div class="panel-heading"><h4>ความคืบหน้า</h4></div>
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <hr>
      <a href="#"><strong><i class="glyphicon glyphicon-list-alt"></i> รายงาน</strong></a>
      <hr>
    </div>
    <div class="col-md-8">
